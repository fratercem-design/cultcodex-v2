      ...
      >
        {SUGGESTED_PROMPTS.map((prompt) => (
          <button
            ...
            className="shrink-0 max-w-[260px] rounded-lg border border-accent-violet/25 bg-black/30 px-3.5 py-2.5 text-left font-mono text-[12px] leading-snug text-text-muted transition-all hover:border-accent-violet/60 hover:bg-accent-violet/10 hover:text-text-primary"
          >
