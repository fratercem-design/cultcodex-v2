    ...
    <aside className={`rounded-lg border border-border/50 bg-surface/30 p-4 ${className ?? ""}`}>
      <div className="flex items-start gap-3">
        ...
        <div className="space-y-1.5">
          <p className="font-mono text-[12px] text-accent-gold-text/80 uppercase tracking-wider font-bold">
            Content Notice
          </p>
          ...
          <Link
            href={correctionHref}
            className="inline-block font-mono text-[12px] text-accent-gold-text hover:text-accent-gold-text/80 hover:underline transition-colors"
          >
