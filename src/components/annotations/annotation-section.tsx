      ...
      {canAnnotate ? (
        ...
        <div className="rounded-xl border border-border bg-surface px-4 py-3 flex items-center justify-between gap-3 flex-wrap">
          ...
          <Link
            ...
            className="font-mono text-[10px] uppercase tracking-widest rounded border border-accent-gold/30 text-accent-gold px-3 py-1.5 hover:bg-accent-gold/5 transition-colors"
          >
