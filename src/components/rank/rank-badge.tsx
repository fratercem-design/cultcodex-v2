...
const COLOR: Record<RankColor, { text: string; border: string; bg: string }> = {
  ...
  violet: { text: "text-accent-violet", border: "border-accent-violet/40", bg: "bg-accent-violet/10" },
  gold: { text: "text-accent-gold", border: "border-accent-gold/40", bg: "bg-accent-gold/10" },
