          ...
          <div className="py-20 text-center space-y-6">
            ...
            {isAdmin ? (
              <Link
                ...
                className="inline-flex items-center gap-2 rounded-lg border border-accent-gold/50 bg-accent-gold/10 hover:bg-accent-gold/20 px-6 py-3 font-mono text-xs font-bold text-accent-gold-text transition-colors"
              >
                Generate Chapters →
              </Link>
            ) : (
