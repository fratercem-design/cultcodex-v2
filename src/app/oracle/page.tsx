...
export const metadata = {
  ...
  description:
    "Ask the archive anything. The Oracle synthesizes nearly 3,000 transmissions into precise answers — behavioral patterns, guest dynamics, recurring moments — all cited back to the source. Initiate+ feature.",
};
