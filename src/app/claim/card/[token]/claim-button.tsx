...
export function ClaimButton({ token }: { token: string }) {
  ...
  if (state === "done") {
    return (
      <p className="font-mono text-xs uppercase tracking-[0.4em] text-accent-gold py-5">
  ...
  return (
    <div className="space-y-4">
      <button
        ...
        className="block w-full py-5 font-mono text-xs uppercase tracking-[0.5em] transition-all text-center text-accent-gold/80 hover:text-accent-gold disabled:opacity-50"
        style={{
