        ...
        {rows.length === 0 ? (
          <>
            ...
            <div className="text-center">
              <Link
                href="/quotes"
                className="inline-flex items-center gap-2 rounded border border-accent-violet/40 bg-accent-violet/10 px-5 py-2 font-mono text-xs font-bold text-accent-violet transition-all hover:bg-accent-violet/20"
              >
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    {row.quote.speaker ? (
                      <Link
                        ...
                        className="font-mono text-[11px] uppercase tracking-widest text-accent-violet hover:underline"
                      >
