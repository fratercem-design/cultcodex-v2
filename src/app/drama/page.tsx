    ...
    <main className="min-h-screen bg-void">
      ...
      <section className="border-b border-red-500/20 bg-gradient-to-b from-red-500/5 to-void py-12 px-4">
        <div className="mx-auto max-w-3xl text-center space-y-3">
          <p className="font-mono text-[9px] uppercase tracking-[0.5em] text-red-400/70">
          ...
          entries.map((entry, i) => (
            ...
            >
              <div className="flex items-start justify-between gap-3">
                ...
                <span className="flex-shrink-0 font-mono text-[10px] text-text-muted/40 group-hover:text-red-400/70 transition-colors">
                  OPEN FILE →
                </span>
              </div>
            </Link>
