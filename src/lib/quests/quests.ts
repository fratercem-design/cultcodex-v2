...
export const QUESTS: Quest[] = [
  ...
  },
  {
    ...
    rite: "Fourth Rite",
    description: "Contribute to the codex — propose a signal or add an annotation. The scribe doesn't just read the codex; they write it.",
    accent: "gold",
    target: 1,
    metric: (a) => a.signalProposals + a.annotations,
    metricLabel: "contributions made",
