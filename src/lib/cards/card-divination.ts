...
export const FAMILIES: Record<CardType, Family> = {
  ...
  QUOTE: {
    archetype: "The Refrain", shadow: "Deafness to what repeats",
    element: "Air", planet: "Mercury", strength: 50,
    uprightTail: "A line has returned to you more than once — repetition is not coincidence, it is the archive insisting. This is the time you finally hear it.",
    uprightFallback: "A message keeps returning. Its repetition is the archive insisting you finally hear it.",
    reversed: "You have heard it so often you have stopped listening. Familiarity has made the warning invisible.",
    advice: "Write the line down. Act on it once before it has to repeat again.",
    oraclePrompt: "What message keeps returning until it is finally heard?",
  },
  EPISODE: {
    archetype: "The Threshold", shadow: "Performing the before",
    element: "Fire", planet: "Sun", strength: 60,
    uprightTail: "A door opened on the record and something crossed through that cannot be uncrossed — you are standing in the after, whether you have admitted it or not.",
    uprightFallback: "A door opened on the record. You are standing in the after, whether you admit it or not.",
    reversed: "You are still performing the before — the broadcast ended and you kept the set lit, talking to an audience that already left.",
    advice: "Name what changed. Stop rehearsing the version of you from before the door.",
    oraclePrompt: "Which threshold have you already crossed but keep pretending is still ahead of you?",
  },
  DEITY: {
    archetype: "The Godform", shadow: "Confusing the mask with the power",
    element: "Aether", planet: "Neptune", strength: 80,
    uprightTail: "A god-force is present — vast, patterned, older than your situation. Work with it as a force, not a wish, and it lends its shape to yours.",
    uprightFallback: "A god-force is present — vast and patterned. Work with it as a force, not a wish.",
    reversed: "You are worshipping the image instead of drawing on the power, or invoking a force you are not willing to be changed by. The godform withdraws when it is only decoration.",
    advice: "Invoke deliberately, and be willing to be changed. Do not summon what you won't let alter you.",
    oraclePrompt: "What larger force are you invoking without being willing to let it change you?",
  },
  LOCATION: {
    archetype: "The Ground", shadow: "Mistaking the place for the self",
    element: "Earth", planet: "Saturn", strength: 55,
    uprightTail: "Where you stand is shaping what you can see — this ground holds what happened here, and the terrain is part of the reading.",
    uprightFallback: "Where you stand shapes what you can see. The ground holds what happened here.",
    reversed: "You have fused with the place — mistaking the room you are in for who you are. Some grounds you outgrow by leaving them.",
    advice: "Read the terrain, then decide whether to stay on it. The ground is context, not identity.",
    oraclePrompt: "What is the place you are standing in doing to what you are able to see?",
  },
  RITUAL: {
    archetype: "The Rite", shadow: "Form emptied of meaning",
    element: "Water", planet: "Moon", strength: 65,
    uprightTail: "A repeated action is changing the one who performs it — the form is the doorway, and doing it with attention is the whole point.",
    uprightFallback: "A repeated action changes the one who performs it. The form is the doorway.",
    reversed: "The rite has emptied into rote — motions performed with no attention, a doorway walked past instead of through.",
    advice: "Perform the rite with attention or not at all. Empty form changes nothing.",
    oraclePrompt: "Which practice have you kept doing long after you stopped meaning it?",
  },
  SYMBOL: {
    archetype: "The Sign", shadow: "Reading the sign, missing the referent",
    element: "Air", planet: "Mercury", strength: 60,
    uprightTail: "A compressed meaning is in front of you — read what it points to, not only what it is; the sign is a finger, not the moon.",
    uprightFallback: "A compressed meaning is in front of you. Read what it points to, not only what it is.",
    reversed: "You are fixated on the symbol and missing what it points at — worshipping the finger instead of following it to the moon.",
    advice: "Follow the sign to its referent. Do not stop at the surface of the image.",
    oraclePrompt: "What is the symbol in front of you actually pointing at that you keep not looking toward?",
  },
  EVENT: {
    archetype: "The Convergence", shadow: "Chasing the high instead of the meaning",
    element: "Aether", planet: "Jupiter", strength: 60,
    uprightTail: "Scattered signals gathered in one place and, for a moment, the whole circuit lit at once — mark it, this is a high-water line, and what it revealed matters more than the crowd.",
    uprightFallback: "Scattered signals gathered and the whole circuit lit at once. Mark the high-water line.",
    reversed: "You are chasing the high of the gathering instead of tending what it revealed — the crowd dispersed and the work it pointed to is still undone.",
    advice: "Capture what the convergence showed you. Build from the signal, not the nostalgia.",
    oraclePrompt: "What did the gathering reveal that you have not yet acted on?",
  },
};
